...
namespace CinemaBooking {
    ...
    public partial class movietheatreDataSet : global::System.Data.DataSet {
        ...
        public partial class filmDataTable : global::System.Data.TypedTableBase<filmRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public filmRow AddfilmRow(string Title, System.TimeSpan RunTime, string Genre, System.DateTime ReleaseDate, string Rating, string Director, string Cast, string Descrption) {
            ...
            private void InitClass() {
                ...
                this.columnCast.MaxLength = 16777215;
                this.columnDescrption.AllowDBNull = false;
                this.columnDescrption.MaxLength = 16777215;
            }
        ...
        public partial class filmRow : global::System.Data.DataRow {
            ...
            public System.TimeSpan RunTime {
                get {
                    return ((global::System.TimeSpan)(this[this.tablefilm.RunTimeColumn]));
                }
                set {
                    this[this.tablefilm.RunTimeColumn] = value;
                }
            }
            ...
            public System.DateTime ReleaseDate {
                get {
                    return ((global::System.DateTime)(this[this.tablefilm.ReleaseDateColumn]));
                }
                set {
            ...
            public string Cast {
                get {
                    return ((string)(this[this.tablefilm.CastColumn]));
                }
                set {
                    this[this.tablefilm.CastColumn] = value;
                }
            }
            ...
            public string Descrption {
                get {
                    return ((string)(this[this.tablefilm.DescrptionColumn]));
                }
                set {
                    this[this.tablefilm.DescrptionColumn] = value;
                }
            }
        }
...
namespace CinemaBooking.movietheatreDataSetTableAdapters {
    ...
    public partial class filmTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `film` WHERE ((`Film_id` = @p1) AND (`Title` = @p2) AND (`RunTime` = " +
                "@p3) AND (`Genre` = @p4) AND (`ReleaseDate` = @p5) AND (`Rating` = @p6) AND (`Di" +
                "rector` = @p7))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `film` (`Title`, `RunTime`, `Genre`, `ReleaseDate`, `Rating`, `Direct" +
                "or`, `Cast`, `Descrption`) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8)";
            ...
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.Text;
            param.IsNullable = true;
            param.SourceColumn = "Descrption";
            param.SourceVersion = global::System.Data.DataRowVersion.Current;
            this._adapter.InsertCommand.Parameters.Add(param);
            this._adapter.UpdateCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `film` SET `Title` = @p1, `RunTime` = @p2, `Genre` = @p3, `ReleaseDate` = @p4, `Rating` = @p5, `Director` = @p6, `Cast` = @p7, `Descrption` = @p8 WHERE ((`Film_id` = @p9) AND (`Title` = @p10) AND (`RunTime` = @p11) AND (`Genre` = @p12) AND (`ReleaseDate` = @p13) AND (`Rating` = @p14) AND (`Director` = @p15))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CinemaBooking.Properties.Settings.Default.movietheatreConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `Film_id`, `Title`, `RunTime`, `Genre`, `ReleaseDate`, `Rating`, `Director" +
                "`, `Cast`, `Descrption` FROM `film`";
        ...
        public virtual int Fill(movietheatreDataSet.filmDataTable dataTable) {
        ...
        public virtual movietheatreDataSet.filmDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            movietheatreDataSet.filmDataTable dataTable = new movietheatreDataSet.filmDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(movietheatreDataSet.filmDataTable dataTable) {
        ...
        public virtual int Delete(int p1, string p2, System.DateTime p3, string p4, System.DateTime p5, string p6, string p7) {
        ...
        public virtual int Insert(string p1, System.DateTime p2, string p3, System.DateTime p4, string p5, string p6, string p7, string p8) {
            if ((p1 == null)) {
        ...
        public virtual int Update(string p1, System.DateTime p2, string p3, System.DateTime p4, string p5, string p6, string p7, string p8, int p9, string p10, System.DateTime p11, string p12, System.DateTime p13, string p14, string p15) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
